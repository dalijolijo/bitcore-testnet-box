python-OP_RETURN v2
===================
Simple Python commands and libraries for using OP_RETURNs in bitcore transactions.
...
* Bitcore Core 0.9 or later


BEFORE YOU START
----------------
Check the constant settings at the top of OP_RETURN.py.
If you just installed Bitcore Core, wait for it to download and verify old blocks.
...
* Examples:
  ...
  python send-OP_RETURN.py mrcUFH3QU3QM8m9494Vfx6Hu5AKdsKQgsw 0.001 'Hello, testnet!' 1
...
* Examples
  ...
  OP_RETURN_send('mrcUFH3QU3QM8m9494Vfx6Hu5AKdsKQgsw', 0.001, 'Hello, testnet!', True)
